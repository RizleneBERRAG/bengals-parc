...
@section('description', "Bengal's Parc, élevage familial déclaré à la chambre d'agriculture à L'Isle d'Abeau. Nos reproducteurs, leur robe, leur pedigree et leurs dépistages.")
...
<section class="band">
    <div class="wrap">
        ...
        <div class="two off">
            <figure class="figure">
                <img src="{{ asset('images/cats/couple.webp') }}" alt="Uzumaki et Uanna, couple de Bengals de la chatterie">
