@props([
    'url',
    'type'   => 'instagram',   {{-- instagram | tiktok | mail | tel --}}
    'handle' => '@bengals_parc',
])
...
{{--
    ...
    Les pictogrammes Instagram et TikTok sont les glyphes officiels, repris sans
    modification de leur tracé : les règles de marque de Meta comme celles de
    TikTok interdisent de les redessiner, de les recolorer autrement qu'en aplat
    uni, de les incliner ou de les déformer.
...
@php
    $externe = in_array($type, ['instagram', 'tiktok'], true);
