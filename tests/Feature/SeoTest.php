...
class SeoTest extends TestCase
{
    ...
    {
        return [
            'reproducteurs'  => ['/reproducteurs', '/elevage'],
            'reproducteurs-2'=> ['/reproducteurs-2', '/elevage'],
            'reservations'   => ['/reservations', '/chatons'],
            'histoire-chats' => ['/histoire-chats', '/le-bengal'],
            'la-race-bengal' => ['/la-race-bengal', '/le-bengal'],
        ];
    }
